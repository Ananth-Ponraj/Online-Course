...
public class declaration extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter your Username and Password for your account!!!");
        ...
        jLabel5.setText("Welcome to Declaration Section!!!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql="insert into usergeneraldetails(username,password) values('"+user+"','"+password+"') where userID="+ID+";";
